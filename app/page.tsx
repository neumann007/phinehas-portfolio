...
import EchoesGlobe from '@/components/EchoesGlobe'
  ...
  return (
    <main className='page'>
      ...
      <section className='hero'>
        <p className='mono hero__tag'>Full-stack engineer</p>
      ...
      <section className='section'>
        <p className='mono' style={{ marginBottom: '2.5rem' }}>
          What I&apos;m up to
        </p>
        ...
        <div className='echoes-section'>
          <div className='echoes-section__content'>
            ...
            >
              ...
              building, what you can&apos;t stop thinking about. Find someone on
              the other side of the world building what you&apos;re building.
            </p>
          </div>
        </div>
      ...
      <section className='scrive-teaser'>
        ...
        >
          ...
          {[100, 250, 400, 550, 650, 800, 950, 1100].map((x2, i) => (
            <polygon
              key={i}
              points={`600,300 ${x2 - 30},0 ${x2 + 30},0`}
              fill='#2dd4bf'
              opacity={0.15}
            />
          ))}
